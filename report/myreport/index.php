                      ...
                      <div id="courses-view-in-progress" data-status="1">
                        <div id="pc-for-in-progress" data-region="paging-content">
                          <div data-region="paging-content-item" data-page="1" class=" " id="yui_3_17_2_1_1515148855696_606">
                            ...
                            ?>
                                <tr class="" id="">
                                 <td class="cell c0" id="report_loglive_r0_c0" style="padding: 10px;"><a href="userreports2.php?modp=userreports2&uid=<?php echo $user_report->id;?>"><?php echo $user_report->username; ?></a></td>
                                  <td class="cell c1" id="report_loglive_r0_c1" style="padding: 10px;"><?php echo $user_report->roletype; ?></td>
                                  <td class="cell c2" id="report_loglive_r0_c2" style="padding: 10px;"><?php echo $access; ?></td>
                                  <td class="cell c3" id="report_loglive_r0_c3" style="padding: 10px;" ><?php echo $user_report->assigned_courses; ?></td>
                                  <td class="cell c4" id="report_loglive_r0_c4"style="padding: 10px;" ><?php echo $user_report->completed_courses; ?></td>
                                  <td class="cell c5" id="report_loglive_r0_c5" style="padding: 10px;" >-</td>
                                </tr>
