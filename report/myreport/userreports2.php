                        ...
                        <div  data-region="paging-content">
                          <div data-region="paging-content-item" data-page="1" class=" " id="yui_3_17_2_1_1515148855696_606">
                            ...
                            <div class="span2 student_detail_area">
                              <h3 class="student_name"> <?php echo $single_user_report->username; ?><br><span style="font-size:12px;"><?php echo $single_user_report->email; ?></span></h3>
                          </div>
                          </div>

                        <div class=" row-fluid detail_list" style="margin-top: 20px;font-size: 14px;">
                          <div class="span6"> <b><?php echo $single_user_report->assigned_courses; ?></b> assigned course &nbsp;.&nbsp;   <b><?php echo $single_user_report->completed_courses; ?></b> Completed course &nbsp;.&nbsp; <b> <?php echo $single_user_certificate_report->certificate_count; ?></b> Certification &nbsp;.&nbsp;  <b>25</b> Points  &nbsp;&nbsp; Last Login: <b><?php echo date('m/d/Y', $single_user_report->lastlogin); ?></b>  </div>
                        </div>
